...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertContact (String nim, String nama, String phone) {
        ...
        contentValues.put("nim", nim); contentValues.put("nama", nama);
    ...
    public ArrayList<String> getAllCotacts() {
        ...
        //hp = new HashMap();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res = db.rawQuery( "select * from mahasiswa", null ); res.moveToFirst();
        while(res.isAfterLast() == false){ array_list.add(res.getString(res.getColumnIndex(MHS_COLUMN_NAMA)));
